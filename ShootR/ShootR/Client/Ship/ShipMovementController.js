...
var ShipMovementController = (function (_super) {
    ...
    ShipMovementController.prototype.Move = function (percentOfSecond, now) {
        ...
        var rotationIncrementor = percentOfSecond * ShipMovementController.ROTATE_SPEED, direction = new Vector2(this.Rotation, false), dragForce = Vector2.MultiplyN(Vector2.MultiplyV(Vector2.MultiplyN(this.Velocity, .5), this.Velocity.Abs()), ShipMovementController.DRAG_COEFFICIENT * ShipMovementController.DRAG_AREA * -1);
