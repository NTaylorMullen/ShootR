($)(window).load(function () {
    ...
    var env = ($).connection.h, configurationManager = {}, screen = new GameScreen($("#game"), $("#gameWrapper"), false, env), shipControllerFn = new ShipControllerFunctions(env), touchController;
