...
var TouchController = (function () {
    function TouchController(_startMovement, _stopMovement, _stopAndStartMovement, _resetMovement, _shipFire) {
        ...
        this._leftJoyStick = new JoyStick(TouchController.LENGTH_OFFSET, [this.Forward, this.Backward], this._startMovement, this._stopMovement, this._stopAndStartMovement, this._resetMovement), this._rightJoyStick = new JoyStick(TouchController.LENGTH_OFFSET, [this.RotatingLeft, this.RotatingRight], this._startMovement, this._stopMovement, this._stopAndStartMovement, this._resetMovement);
    }
